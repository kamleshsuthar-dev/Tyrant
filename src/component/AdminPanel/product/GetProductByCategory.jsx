...
import DeleteBtn from '@/component/home/DeleteBtn'
import {
  useNavigate,
  Link,
  useLoaderData,
...
export default function GetProductByCategory() {
  ...
  const addProduct = ()=>{
    console.log("click");
    navigate('/admin/product/add' , {state : {cId}})
  }
...
const deleteProduct = async (e, productId) => {
  ...
  try {
    ...
    let res = await axios.delete(`${import.meta.env.VITE_ADMIN_DELETE_PRODUCT}/${productId}`);
     ...
     return (
      <div className="bg-white relative">
        ...
        <div className="bg-gray-100 w-full  flex items-center justify-center relative py-5 mt-5">
          ...
          <Button variant="outline" className="absolute right-5 text-lg" onClick={addProduct}>
