        ...
        <div className=' h-full w-full grid  place-items-center bg-[url(./public/images/bgImgJaipur.png)]   rounded-2xl  '>
          ...
          <div className='card min-w-[350px] min-h-[60%]  bg-white rounded-xl text-black grid gap-2 items-center p-[52px] font-comfortaa text-lg '>
            ...
            <div className='grid gap-1'>
              ...
              <div className='col-span-1 row-span-1 rounded-xl bg-white flex items-center justify-center gap-2 py-1 text-center text-xl   text-[#3F3F3F] border-2 border-solid border-black '><svg width="22" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
