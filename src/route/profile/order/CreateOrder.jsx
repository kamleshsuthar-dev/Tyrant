...
function CreateOrder({profile,Tamount,cartItems,addressId,paymentMethod,isPaid}) {
  ...
  return (
    <div>
         <Button onClick= {handleOrder} className="w-full bg-lime-400 hover:bg-lime-500 text-black mt-4 capitalize">
         cash-on-delivery &gt;&gt;
                  </Button>
    </div>
  )
