...
//                 {address.isDefault ? (
//                   <div className="bg-gray-800 text-secondary text-xs px-3 py-1 rounded-md">Default Address</div>
//                 ) : (
//                   <button
...
//                 <button
//                   className="bg-red-500 hover:bg-red-600 text-secondary py-1 rounded"
//                   onClick={() => handleDelete(address.id)}
//                 >
//                   Delete
//                 </button>
//                 <button className="bg-green-400 hover:bg-green-500 text-primary py-1 rounded">Update</button>
//               </div>
//             </CardContent>
//           </Card>
//         ))}
