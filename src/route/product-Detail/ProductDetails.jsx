...
import { GetApi, PostApi } from "@/features/reuseable-component/ApiCaller";
...
export default function ProductDetail() {
  ...
  const [categoryData, categoryError, categoryLoading] = GetApi(product?.pCategory ? `${import.meta.env.VITE_PRODUCT_BY_CATEGORY}?cId=${product.pCategory}`: null,"get product by category api"
  );
  ...
  // const [Wdata, Werror, Wloading] = GetApi(`${import.meta.env.VITE_PRODUCT_SINGLE_PRODUCT}?pId=${pId}`,"get product by category api ");
  // useEffect(() => {

  //   if (Wdata?.data?.product.isInWishlist) {
  //     setWishlist(true);
  //   } else {
  //     setWishlist(false);
  //   }

  //   if (Wdata && Wdata.data && Wdata.data.products) {
    ...
    <>
      <div className="min-h-screen bg-white p-4" id="top">
                ...
                <div>
                  ...
                  <span className={` flex justify-center items-center gap-1 ${product.reviewCount==0 ? "hidden":" "}`}>
                    ...
                    xmlns="http://www.w3.org/2000/svg" width="7" height="5" viewBox="0 0 7 3" className="pt-[1px]" fill="none">
                        <path d="M1 0.5L3.5 2.5L6 0.5" stroke="#202020" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
        ...
        <div className=" mt-4">
          ...
          {/* Similar Products */}
          <div className="mt-8 grid grid-cols-auto md:grid-cols-4 gap-4"  >
                {
