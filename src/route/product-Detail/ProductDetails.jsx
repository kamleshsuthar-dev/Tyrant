            ...
            <div className="grid md:grid-cols-2 gap-8   p-4 md:p-8 ">
              ...
              <div className="space-y-6">
                ...
                {/* <Button
                      ...
                      variant="ghost"
                      size="icon"
                      className={`absolute  right-40 inline-flex items-center justify-center p-2 rounded-full transition-all duration-200 ${
