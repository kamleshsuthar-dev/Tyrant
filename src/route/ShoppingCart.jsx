 ...
 useEffect(()=>{
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      <h1 className="text-2xl font-bold text-center bg-gray-800 text-white p-4 mb-6 rounded-xl 
      bg-gradient-to-r from-black to-slate-500">SHOPPING CART</h1>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="hidden lg:block">
            ...
            {products.map((product) => (
              <div key={product.id} className="grid grid-cols-[2fr,1fr,1fr,1fr] gap-4 items-center mb-4 border-b pb-4">
        ...
        <div>
          <Card>
            <CardContent className="p-6">
              ...
              <Button className="w-full mt-4 bg-green-500 hover:bg-green-600">CHECKOUT &gt;&gt;</Button>

              <div className="mt-6">
                <h3 className="font-bold mb-2">COUPON CODE</h3>
                <input type="email" placeholder="Enter Email Address" className="mb-2" />
                <Button className="w-full bg-green-500 hover:bg-green-600">APPLY COUPON</Button>
              </div>
            </CardContent>
          </Card>
        </div>
