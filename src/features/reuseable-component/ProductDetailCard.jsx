              ...
              <div className="space-y-2">
                ...
                <div className="relative space-y-2 !mt-2 ">
                    <div className="absolute  right-8 flex gap-2 ">
                      <button className={ `bg-none scale-[0.85] ${
                    ...
                    >
                      {sizes.map((size) => {
                        return (
                          <Label
                            key={size}
                            className={`py-[3px] rounded-xl border-2 w-[60px] cursor-pointer text-sm text-[#FFFFFF] bg-[#42985A] flex items-center justify-center  ${
                              selectedSize === size
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-2 bg-[#202020] w-fit text-[#FFFFFF] rounded-lg">
                      <Button
                        variant="outline"
                        size="icon"
                        className="bg-transparent hover:bg-transparent hover:text-[#FFFFFF] border-none w-7 h-8"
                ...
                <div className="flex flex-row gap-4 w-full flex-wrap ">
                  ...
                  <Button
                    className="flex w-full text-xl text-[#FFFFFF] bg-[#202020] py-5 px-[144px] rounded-xl"
                    onClick={addtoCart}
                  >
                    Add to Cart
                  </Button>
                  ...
                  <Button
                    variant="secondary"
                    className="flex w-full text-xl text-[#202020] bg-[#9EFF00] py-5 px-[144px] rounded-xl"
                    onClick={checkOut}
                  >
                    Buy Now
                  </Button>
