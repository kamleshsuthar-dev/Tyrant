...
export default function GetCategory() {
  ...
  const CategoryProduct = (categoryId, categoryName) => {
    ...
    navigate(`/admin/category/allproduct/${categoryId}`, {
      state: { categoryName },
    });
  };
  ...
  return (
    <div className="p-6 relative">
      ...
      <div className="overflow-x-auto">
        <table className="w-full bg-secondary shadow-md rounded-lg">
          ...
          <tbody>
            {categories.map((category) => (
              ...
              >
                ...
                <td className="p-3">
                  <button
                    className="bg-primary text-secondary px-4 py-2 rounded hover:bg-gray-600"
                ...
                <td className="p-3">
                  <button
                    ...
                    onClick={() =>
                      CategoryProduct(category._id, category.cName)
                    }
                  >
                    View Products
                  </button>
                ...
                <td
                  className="p-3   right-0 mt-5 h-12 w-9 bg-[#FF1010] rounded-md flex justify-center items-center"
