...
export default function ReviewSection({ avgRating, onReviewChange }) {
  ...
  const { reviews, ratingStats, reviewLoading, reviewMessage, reviewPagination, addReview, deleteReview, setRatingStats,} = useReviews(pId, sortValue, filterValue, onReviewChange);

  useEffect(() => {
    setRatingStats((prev) => ({ ...prev, average: avgRating }));
  }, [avgRating, setRatingStats]);
