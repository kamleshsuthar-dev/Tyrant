...
//   const [categoryProducts, setCategoryProducts] = useState(initialCategoryP || null);
...
//   // Fetch category products using custom hook
//   const [categoryData, categoryError, categoryLoading] = GetApi(
//     product?.pCategory 
//       ? `${import.meta.env.VITE_PRODUCT_BY_CATEGORY}?cId=${product.pCategory}`
//       : null,
...
//       setCategoryProducts(initialCategoryP);
//     }
//   }, [pId, initialProduct, fetchProduct, initialCategoryP]);

//   useEffect(() => {
//     if (categoryData?.data?.products) {
//       setCategoryProducts(categoryData.data.products);
//     }
//   }, [categoryData]);
...
//         `${import.meta.env.VITE_ADD_CART_PRODUCT}`,
//         {
//           productId: pId,
//           quantity,
//           color: selectedColor,
...
//     }
//   }, [isLoginUser, pId, quantity, selectedColor, selectedSize]);
...
//                       <ShoppingCartTopUp ref={popUpRef} product={product} />
//                     </Suspense>
//                   </div>
//                   <Button
//                     variant="primary"
...
//                   <PorductCard product={p} categoryP={categoryProducts}/>
//                 ))}
//               </>
//             ) : (
//               <></>
